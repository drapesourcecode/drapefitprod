...
class PagesController extends AppController {
    ...
    public function beforeFilter(Event $event) {
        ...
        $this->Auth->allow(['executive', 'investors', 'news', 'whoWeAre', 'WorkWithUs','ourMission','outStylist','styleBlog','feedbackReview','returnExchange','trackOrder','map', 'helpCenter', 'aboutus', 'privacy', 'termsCondition', 'faq', 'blog', 'careers', 'cookieInfo', 'gifts', 'sitemap', 'supplyChainInformation', 'contactUs', 'influencerProgram']);
    }
