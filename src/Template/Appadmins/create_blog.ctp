                    ...
                    <div class="tab-content" style="width: 100%;float: left;">
                        <div class="tab-pane active" id="profile">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputName">Author Description <span style="color: red;">*</span></label>
                                        <?= $this->Form->input('auther_descriptions', ['type' => 'textarea', 'placeholder' => "Enter author description", 'class' => "form-control", 'label' => false, 'kl_virtual_keyboard_secure_input' => "on", 'required' => "required", 'value' => @$dataEdit->auther_descriptions, 'data-error' => 'Enter author description']); ?>
                                        <?= $this->Form->input('id', ['type' => "hidden", 'label' => false, 'value' => @$dataEdit->id]); ?>
                                        <div class="help-block with-errors"></div>
                                    </div>                                    
                                </div>
